...
#设置只保留特定时间，包含新增加的内容，最后导出的文件
filepath_action_done = 'D:\code\code\code2\message_ass.db.222.action.result'
filepath_action_done = DealWithTxt.process_wrong_enter(filepath_action_done)

#恢复完成后的文件
filepath_action_recover_done = 'D:\code\code\code2\message_ass.db.222.action.recover.result'
